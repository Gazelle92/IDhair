            ...
            <ul className="right">
              <li>
                ...
                <div className="l_b">
                  <b>/    스타일 워크</b>
                  <span>
                    살롱 실무에 바로 적용할 수 있도록 구성된 idHAIR만의 커트 교육 시스템으로 총 56가지 커트 스타일을 14단계, 2년 4개월의 과정​으로 세분화하여 기초부터 응용까지 단계적으로 트레이닝 합니다.<br/><br/>
                    단순한 스타일 완성을 넘어 고객의 모질·두상·얼굴형에 따른 체계적인 커트 프로세스와 살롱 테크닉 노하우, 쉽고 빠르게 적용할 수 있는 실전 테크닉, 디자인별 드라이 방법​까지 함께 익힐 수 있습니다. <br/><br/>
                    반복적인 실습과 단계별 교육을 통해 누구나 다양한 스타일을 연출하고, 실제 살롱 현장에서 바로 활용할 수 있는 실전형 커트 역량을 키우는 것이 스타일워크의 핵심입니다.
                  </span>
                </div>
              </li>
              <li>
                ...
                <div className="l_b">
                  <b>/    스타트 워크</b>
                  <span>
                    스타일워크를 시작하기 전, 파트너가 살롱의 구성원으로서 갖춰야 할 기본적인 자세와 마음가짐을 배우는 기초 소양 교육입니다.<br/><br/>
                    각 매장의 리더들이 직접 강사로 참여하여 살롱에서의 기본적인 태도와 책임감, 동료와의 관계, 고객을 대하는 자세 등 현장에서 필요한 다양한 경험과 노하우를 전달합니다.<br/><br/>
                    기술을 배우기에 앞서 미용인으로서 갖춰야 할 기본 마인드와 개인 소양을 확립하고, 살롱의 문화와 업무 환경에 자연스럽게 적응할 수 있도록 돕는 과정입니다.
                  </span>
                </div>
              </li>
              <li>
                ...
                <div className="l_b">
                  <b>/    살롱 워크</b>
                  <span>
                    idHAIR 디자이너를 위한 실전 중심의 전문 교육 프로그램입니다.<br/><br/>
                    idHAIR 내부에서 풍부한 현장 경험과 노하우를 가진 디자이너와 다양한 분야의 외부 전문 디자이너를 초청하여, 실제 살롱에서 직접 활용하고 있는 커트·펌·염색 등 다양한 테크닉과 시술 노하우를 강의 또는 세미나 형태로 공유합니다.<br/><br/>
                    단순히 정형화된 기술을 배우는 것을 넘어, 디자이너들이 현장에서 경험하며 쌓아온 실질적인 노하우와 효율적인 시술 방법, 고객 응대 및 살롱 활용 팁​까지 접할 수 있는 시간 입니다.<br/><br/>
                    이를 통해 디자이너의 시야를 넓히고, 새로운 기술과 트렌드를 자신의 살롱 실무에 효과적으로 적용할 수 있도록 돕습니다.
              ...
              <li>
                ...
                <div className="l_b">
                  <b>/    테크닉 워크</b>
                  <span>
                    살롱 실무에 필요한 다양한 시술 테크닉을 체계적으로 배우고 현장에 바로 적용할 수 있도록 구성된 실전 테크닉 강의입니다.<br/><br/>
                    펌과 염색을 중심으로 살롱에서 자주 활용되는 8가지 펌 테크닉과 16가지 염색 테크닉 강의를 통해 기본 원리부터 시술 과정, 약제 활용, 디자인별 테크닉까지 단계적으로 학습합니다.<br/><br/>
                    단순한 이론 교육을 넘어 실제 시술에서 필요한 쉽고 효율적인 방법을 익혀, 다양한 고객과 모질에 유연하게 대응하고 빠르고 안정적인 시술 결과를 만들어낼 수 있는 실무 역량을 키우는 것을 목표로 합니다.
      ...
      <section className="ac_2 ">
        ...
        <div className="flex_w">
          <div className="flex ani">
            ...
            <ul className="right">
              <li>
                <h4 className="body-l fw-b">Head of id Academy</h4>
